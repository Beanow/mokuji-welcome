...
<html>
  ...
  */ ?>
  ...
  <?php /*
    ...
    Here starts the body of your new Welcome template. Most changes happen here.
  ...
  */ ?>
  <body class="welcome-template clearfix">
    
    <header id="header">
      <nav class="main-menu">
        <?php
          //This is an example menu module, keep in mind the max_depth prevents it from showing sub-items.
          echo tx('Component')->modules('menu')->get_html('menu', array('max_depth' => 3));
        ?>
      </nav>
    </header>
